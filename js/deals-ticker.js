...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent =
      '.deals-ticker{border-bottom:1px solid rgba(200,169,74,.4);background:#000}' +
      '.deals-ticker-head{display:flex;align-items:center;gap:8px;padding:6px 12px;border-bottom:1px solid rgba(200,169,74,.2);background:rgba(200,169,74,.05)}' +
      '.deals-ticker-head svg{flex-shrink:0}' +
      '.deals-ticker-label{font-size:10px;font-weight:700;letter-spacing:.2em;text-transform:uppercase;color:var(--gold,#C8A94A)}' +
      ...
      '.deals-ticker-item:hover{background:rgba(200,169,74,.1)}' +
      '.deals-ticker-arrow{color:rgba(200,169,74,.5)}' +
      '.deals-ticker-name{color:var(--gold,#C8A94A);font-weight:700;text-decoration:underline;text-decoration-color:rgba(200,169,74,.3);text-underline-offset:2px}' +
      '.deals-ticker-old{color:rgba(200,169,74,.4);text-decoration:line-through}' +
      '.deals-ticker-new{color:#F5F0E8;font-weight:700}' +
      '.deals-ticker-save{color:rgba(200,169,74,.7)}';
