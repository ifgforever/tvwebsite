(function () {
  ...
  button.style.cssText = 'position:fixed;right:14px;bottom:14px;z-index:9999;padding:10px 13px;border:1px solid var(--gold, #c8a94a);border-radius:999px;background:var(--surface, #111);color:var(--paper, #f5f1e8);font:700 12px Arial,sans-serif;text-decoration:none;box-shadow:0 6px 24px rgba(0,0,0,.55)';
